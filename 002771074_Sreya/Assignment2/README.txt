** Student protfolio for Sreya Vallabhaneni **
...
* For a student, a digital portfolio can stand as an easily accessible collection of their performance, 
and in turn, documentation of their academic progress over time.

* The navbar conatins links to each section. User can directly go to any section of portfoilo

* the iamge and about me introductions are parallely aligned using column css styling. 

* for round borders of the image, use border-radius in css. 
...
-> Navbar: 
A navigation bar (also called a Navbar) is a user interface element within a webpage that contains 
links to other sections of the website. In most cases, the navigation bar is part of the main website template,
 which means it is displayed on most, if not all, of the pages within the website.
